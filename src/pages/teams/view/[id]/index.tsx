...
function TeamViewPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<TeamInterface>(
    ...
    () =>
      getTeamById(id, {
        relations: ['user', 'performance_evaluation', 'time_tracking'],
      }),
  );
              ...
              {hasAccess('performance_evaluation', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/performance-evaluations/create?team_id=${data?.id}`}>
              ...
              {hasAccess('time_tracking', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/time-trackings/create?team_id=${data?.id}`}>
                      <Button colorScheme="blue" mr="4" as="a">
                        Create
                      </Button>
                    </NextLink>
